...
function GiftTypeSelector(t0) {
    ...
    if ($[0] !== "7846ec8b2e88a9cbfecfe98662a3a3f0c10f6e4a99289320ea05d807994415ee") {
        for(let $i = 0; $i < 10; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "7846ec8b2e88a9cbfecfe98662a3a3f0c10f6e4a99289320ea05d807994415ee";
    }
...
function CoffeeConfig(t0) {
    ...
    if ($[0] !== "d4f53738d706f3acddc2d42954e553274c519675fd9809d77c002a3b53b1d6d1") {
        for(let $i = 0; $i < 23; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "d4f53738d706f3acddc2d42954e553274c519675fd9809d77c002a3b53b1d6d1";
    }
    const { value, onChange } = t0;
    const t1 = value.drink || "";
    let t2;
    if ($[1] !== onChange || $[2] !== value) {
        t2 = ({
            "CoffeeConfig[<input>.onChange]": (e)=>onChange({
                    ...value,
                    drink: e.target.value
                })
        })["CoffeeConfig[<input>.onChange]"];
        $[1] = onChange;
        $[2] = value;
        $[3] = t2;
    } else {
    ...
    if ($[7] !== onChange || $[8] !== value) {
        t5 = ({
            "CoffeeConfig[<input>.onChange]": (e_0)=>onChange({
                    ...value,
                    size: e_0.target.value
                })
        })["CoffeeConfig[<input>.onChange]"];
        $[7] = onChange;
        $[8] = value;
    ...
    if ($[13] !== onChange || $[14] !== value) {
        t8 = ({
            "CoffeeConfig[<input>.onChange]": (e_1)=>onChange({
                    ...value,
                    milk: e_1.target.value
                })
        })["CoffeeConfig[<input>.onChange]"];
        $[13] = onChange;
        $[14] = value;
...
function GiftCardConfig(t0) {
    const $ = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$compiler$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["c"])(10);
    if ($[0] !== "78aec9a434f3d12d3136baa7a66f21d758d95a65a7023ae1241602e2767a2be1") {
        for(let $i = 0; $i < 10; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "78aec9a434f3d12d3136baa7a66f21d758d95a65a7023ae1241602e2767a2be1";
    }
    const { value, onChange } = t0;
    const t1 = value.amount || "";
    let t2;
    if ($[1] !== onChange || $[2] !== value) {
        t2 = ({
    ...
    if ($[7] === Symbol.for("react.memo_cache_sentinel")) {
        t4 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
            ...
            children: "(Mocked gift card for now)"
        }, void 0, false, {
            fileName: "[project]/components/GiftCardConfig.js",
            lineNumber: 42,
            columnNumber: 10
...
function ChocolateConfig(t0) {
    ...
    if ($[0] !== "8fa6dec1e6e0f39f914719fc85dfc0aac5d713391b7da03f12ad48a0ce4b926a") {
        for(let $i = 0; $i < 16; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "8fa6dec1e6e0f39f914719fc85dfc0aac5d713391b7da03f12ad48a0ce4b926a";
    }
    const { value, onChange } = t0;
    ...
    if ($[1] !== onChange || $[2] !== value) {
        t2 = ({
            "ChocolateConfig[<input>.onChange]": (e)=>onChange({
                    ...value,
                    title: e.target.value
                })
        })["ChocolateConfig[<input>.onChange]"];
        $[1] = onChange;
        $[2] = value;
        $[3] = t2;
    } else {
    ...
    if ($[7] !== onChange || $[8] !== value) {
        t5 = ({
            "ChocolateConfig[<input>.onChange]": (e_0)=>onChange({
                    ...value,
                    asin: e_0.target.value
                })
        })["ChocolateConfig[<input>.onChange]"];
        $[7] = onChange;
        $[8] = value;
...
function CreatePage() {
    ...
    if ($[0] !== "572b17bb9600dcdbbd5dab5652398dd09b86ac4ca5bbd1248fa1808677553abf") {
        for(let $i = 0; $i < 34; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "572b17bb9600dcdbbd5dab5652398dd09b86ac4ca5bbd1248fa1808677553abf";
    }
    ...
    const [giftType, setGiftType] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("COFFEE");
    let t0;
    if ($[1] === Symbol.for("react.memo_cache_sentinel")) {
        t0 = {};
        $[1] = t0;
    ...
    const [giftConfig, setGiftConfig] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(t0);
    ...
    let t1;
    if ($[2] !== giftConfig || $[3] !== giftType || $[4] !== questionText || $[5] !== recipientName || $[6] !== senderName) {
        t1 = async function handleCreate() {
    ...
    if ($[9] === Symbol.for("react.memo_cache_sentinel")) {
        t3 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
            ...
            onChange: {
                "CreatePage[<input>.onChange]": (e)=>setSenderName(e.target.value)
            }["CreatePage[<input>.onChange]"]
        }, void 0, false, {
            fileName: "[project]/src/app/create/page.js",
            lineNumber: 69,
            columnNumber: 10
    ...
    if ($[10] === Symbol.for("react.memo_cache_sentinel")) {
        t4 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
            ...
            onChange: {
                "CreatePage[<input>.onChange]": (e_0)=>setRecipientName(e_0.target.value)
            }["CreatePage[<input>.onChange]"]
        }, void 0, false, {
            fileName: "[project]/src/app/create/page.js",
            lineNumber: 78,
    ...
    if ($[11] === Symbol.for("react.memo_cache_sentinel")) {
        t5 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("textarea", {
            ...
            placeholder: "Message",
            onChange: {
                "CreatePage[<textarea>.onChange]": (e_1)=>setQuestionText(e_1.target.value)
            }["CreatePage[<textarea>.onChange]"]
        }, void 0, false, {
            fileName: "[project]/src/app/create/page.js",
            lineNumber: 87,
            columnNumber: 10
    ...
    let t11;
    if ($[25] !== link) {
        t11 = link && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
            className: "mt-4",
            children: [
                "Share this link:",
                " ",
    ...
    let t12;
    if ($[27] !== t10 || $[28] !== t11 || $[29] !== t6 || $[30] !== t7 || $[31] !== t8 || $[32] !== t9) {
...
_s(CreatePage, "cP5gAf2vU10P53GQZbm4PGeWnrI=");
_c = CreatePage;
var _c;
...
//# sourceMappingURL=_7cccde7a._.js.map