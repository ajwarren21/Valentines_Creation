...
;
;
function GiftPage(t0) {
    _s();
    const $ = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$compiler$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["c"])(20);
    if ($[0] !== "e8aafa702eb1e5a0047a9d6f3a92530a0f6473cbf2236eb354eebb49255fae8e") {
        for(let $i = 0; $i < 20; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "e8aafa702eb1e5a0047a9d6f3a92530a0f6473cbf2236eb354eebb49255fae8e";
    }
    const { params } = t0;
    const { slug } = params;
    ...
    if ($[1] !== slug) {
        t1 = ({
            "GiftPage[useEffect()]": ()=>{
                fetch(`/api/gift/${slug}`).then(_GiftPageUseEffectAnonymous).then(setGift);
            }
        })["GiftPage[useEffect()]"];
        t2 = [
            slug
    ...
    let t4;
    if ($[7] !== gift.recipientName || $[8] !== gift.senderName) {
    ...
    if ($[10] !== gift.questionText) {
        ...
        $[10] = gift.questionText;
        $[11] = t5;
    } else {
        t5 = $[11];
    }
    let t6;
    if ($[12] !== acceptGift || $[13] !== fulfilled || $[14] !== gift) {
        t6 = !fulfilled ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
            className: "bg-green-500 text-white px-4 py-2",
            onClick: acceptGift,
            children: "Accept Gift"
        }, void 0, false, {
            fileName: "[project]/src/app/g/[slug]/page.js",
            lineNumber: 82,
            columnNumber: 23
...
_s(GiftPage, "/utut4qehtGEAyQV0vgkSDI7dOo=");
_c = GiftPage;
...
//# sourceMappingURL=_6aecbabd._.js.map